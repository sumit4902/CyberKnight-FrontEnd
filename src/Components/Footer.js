            ...
            <div className=" grid ipadmini:grid-cols-4 grid-cols-2 pt-5 text-white bg-[conic-gradient(at_top_left,_var(--tw-gradient-stops))] from-gray-900 via-indigo-900 to-sky-900">
                ...
                <div className="flex flex-col ">
                    ...
                    <div className=" flex flex-col justify-center items-center   gap-y-2 p-2 px-5  text-stone-300">
                        ...
                        <span className="">Welcome to CyberNight, where we provide resources and Practical Implementation  to secure your digital world.</span>
                        <div className=" flex flex-row justify-around w-full">
                            <a href='https://www.facebook.com/sumitpatel.patel.7146?mibextid=ZbWKwL' className=""> <svg class="relative border rounded-full z-10 fill-rose-100 transition-all duration-300 hover:fill-orange-500 " xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 72 72" fill="none">
                                <path
                                    d="M46.4927 38.6403L47.7973 30.3588H39.7611V24.9759C39.7611 22.7114 40.883 20.4987 44.4706 20.4987H48.1756V13.4465C46.018 13.1028 43.8378 12.9168 41.6527 12.8901C35.0385 12.8901 30.7204 16.8626 30.7204 24.0442V30.3588H23.3887V38.6403H30.7204V58.671H39.7611V38.6403H46.4927Z"
                                    fill="" />
                            </svg></a>
                            <a href='https://www.instagram.com/sumit_patel.ss/' className="">
                                <svg class="fill-white rounded-full cursor-pointer  relative z-10 transition-all duration-500 hover:fill-orange-500" xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 51 51" fill="none">
                                    <path
                            ...
                            <a href='https://x.com/SumitPatel87909?t=0vsnpMpg9R2pTkN6edqBhA&s=09' className=""> <svg class="fill-white cursor-pointer border rounded-full p-1 z-10 transition-all duration-300 hover:fill-orange-500" xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 72 72" fill="none">
                                <path
                                    d="M40.7568 32.1716L59.3704 11H54.9596L38.7974 29.383L25.8887 11H11L30.5205 38.7983L11 61H15.4111L32.4788 41.5869L46.1113 61H61L40.7557 32.1716H40.7568ZM34.7152 39.0433L32.7374 36.2752L17.0005 14.2492H23.7756L36.4755 32.0249L38.4533 34.7929L54.9617 57.8986H48.1865L34.7152 39.0443V39.0433Z"
                                    fill="" />
                            </svg></a>
                            <a href='https://www.linkedin.com/in/sumit-patel-25223a234' className="">
                                <svg class="fill-white rounded-full cursor-pointer border  relative z-10 transition-all duration-300 hover:fill-orange-500" xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 72 72" fill="none">
                ...
                <div className=" flex flex-col">
                    ...
                    <div className=" flex flex-col ps-5 gap-y-3 p-2  text-stone-300 ">
                        <Link to='EncryptionTool/AES' className="ps-0 hover:ps-4 transition-all hover:text-amber-500 ">AES</Link>
                        <Link to='EncryptionTool/DES' className="ps-0 hover:ps-4 transition-all hover:text-amber-500 ">DES </Link>
                        <Link to='EncryptionTool/ShiftCipher' className="ps-0 hover:ps-4 transition-all hover:text-amber-500 ">SHIFTCIPHER</Link>
                        <Link to='EncryptionTool/Monoalphabetic' className="ps-0 hover:ps-4 transition-all hover:text-amber-500 ">MONOALPHBETIC</Link>
                        <Link to='EncryptionTool/Polyalphabetic' className="ps-0 hover:ps-4 transition-all hover:text-amber-500 ">POLYALPHBETIC</Link>
                        <Link to='EncryptionTool/DigitalSignature' className="ps-0 hover:ps-4 transition-all hover:text-amber-500 ">DIGITALSIGNATURE</Link>
                        <Link to='EncryptionTool/Hash' className="ps-0 hover:ps-4 transition-all hover:text-amber-500 ">HASHFUNCTION</Link></div>
                </div>
                <div className="flex flex-col">
                    <span className="  w-full p-4 text-xl border-l">Blogs</span>
                    <div className=" flex flex-col ps-5 gap-y-3 p-2 text-stone-300">
                        <Link to='/Blog' className="ps-0 hover:ps-4 transition-all hover:text-amber-500">SOCIAL ENGINEERING</Link>
                        <Link to='/Blog' className="ps-0 hover:ps-4 transition-all hover:text-amber-500">PHISHNG ATTACK</Link>
                        <Link to='/Blog' className="ps-0 hover:ps-4 transition-all hover:text-amber-500">RANSOMEWARE ATTACK</Link>
                        <Link to='/Blog' className="ps-0 hover:ps-4 transition-all hover:text-amber-500">DOS & DDOS ATTACK</Link>
                        <Link to='/Blog' className="ps-0 hover:ps-4 transition-all hover:text-amber-500">WEB JACKING</Link>
                        <Link to='/Blog' className="ps-0 hover:ps-4 transition-all hover:text-amber-500">SQL INJECTION</Link>
                        <Link to='/Blog' className="ps-0 hover:ps-4 transition-all hover:text-amber-500">MAN IN THE MIDDLE ATTACK</Link>
                    </div>

                </div>
                <div className=" flex flex-col">
                    <span className="  w-full p-4 text-xl border-l">JOIN US</span>
                    <div className=" flex flex-col justify-center items-center gap-y-3  text-stone-300">
                        <span className="p-2">Join us on this journey to make the digital space safer and more secure for everyone.
                        </span>
                    </div>
                </div>
            </div>
