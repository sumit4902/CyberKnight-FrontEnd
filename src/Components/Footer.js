                ...
                <div className="flex flex-col ">
                    ...
                    <div className=" flex flex-col justify-center items-center   gap-y-2 p-2 px-5  text-stone-300">
                        ...
                        <div className=" flex flex-row justify-around w-full">
                            <a href='/' className=""> <svg class="relative border rounded-full z-10 fill-rose-100 transition-all duration-300 hover:fill-orange-500 " xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 72 72" fill="none">
                                <path
                            ...
                            <a href='/' className=""> <svg class="fill-white cursor-pointer border rounded-full p-1 z-10 transition-all duration-300 hover:fill-orange-500" xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 72 72" fill="none">
                                <path
